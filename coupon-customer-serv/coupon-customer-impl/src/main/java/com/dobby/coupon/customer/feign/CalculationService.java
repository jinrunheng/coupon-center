...
import com.dobby.coupon.customer.feign.fallback.CalculationServiceFallbackFactory;
 ...
 */
@FeignClient(value = "coupon-calculation-serv", path = "/calculator", fallbackFactory = CalculationServiceFallbackFactory.class)
